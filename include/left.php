<?php
print ("
<tr><td id='navhead1'>Kategorien</td></tr>
...
print ("<tr><td id='$tabid'><a href='content.php?kat=$db_katid&sess=$sess&ts=$ts&next=0&page=1' class='a1'>$db_kategorie</a></td></tr>");
$x++;
}
print ("
<tr><td id='space' height=10>&nbsp;</td></tr>
<tr><td id='navhead2'>Wir akzeptieren</td></tr>
<tr><td id='space' height=10>&nbsp;</td></tr>
