...
print ("
<tr><td id='navhead1'>Warenkorb</td></tr>
<tr><td id='space' height=10>&nbsp;</td></tr>
<tr><td>
<table id='tableright1' align=center border=0 cellpadding=0 cellspacing=0>
<tr height=20><td width=75>Artikel</td><td width=75 align=right>$bmengeges</td></tr>
<tr height=20><td width=75>$db_adminwaehrung</td><td width=75 align=right>$bgesamt1</td></tr>
...
<tr><td id='space' height=10>&nbsp;</td></tr>
<tr><td id='navhead2'>Shopinformationen</td></tr>
<tr><td id='space' height=10>&nbsp;</td></tr>
<tr><td id='navi1'><a href='index.php?sess=$sess&ts=$ts' class='a1' onFocus='if (this.blur) this.blur()'>Startseite</a></td></tr>
<tr><td id='navi1'><a href='zahlung.php?sess=$sess&ts=$ts' class='a1' onFocus='if (this.blur) this.blur()'>Zahlung und Versand</a></td></tr>
<tr><td id='navi1'><a href='widerrufsrecht.php?sess=$sess&ts=$ts' class='a1' onFocus='if (this.blur) this.blur()'>Widerrufsrecht</a></td></tr>
<tr><td id='navi1'><a href='agb.php?sess=$sess&ts=$ts' class='a1' onFocus='if (this.blur) this.blur()'>AGB</a></td></tr>
<tr><td id='navi1'><a href='impressum.php?sess=$sess&ts=$ts' class='a1' onFocus='if (this.blur) this.blur()'>Impressum</a></td></tr>
<tr><td id='navi1a'><a href='kontakt.php?sess=$sess&ts=$ts&action=1' class='a1' onFocus='if (this.blur) this.blur()'>Kontakt</a></td></tr>
<tr><td id='space' height=10>&nbsp;</td></tr>");
...
if ($z!=0) {
print ("<tr><td id='navhead2'>Top-Artikel</td></tr>
